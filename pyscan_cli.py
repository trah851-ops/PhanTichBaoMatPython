#!/usr/bin/env python3
# pyscan_cli.py - CLI TOOL FOR CI/CD INTEGRATION
"""
PyScan Pro CLI - Security Scanner cho CI/CD Pipeline

Usage:
    pyscan scan <path> [options]
    pyscan report <scan_id>
    pyscan compare <scan_id1> <scan_id2>
    pyscan baseline <path>
    pyscan check [--fail-on critical|high|medium]

Examples:
    pyscan scan . --format json --output report.json
    pyscan scan src/ --fail-on high
